    ...
    <ToastProvider>
      <ConfirmProvider>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-6 py-10">
          <div className="mb-10 border-b border-white/[0.08] pb-4 sm:pb-6">
            <div className="flex items-center justify-between gap-3">
              <Link href="/" className="flex shrink-0 items-center gap-2.5 font-extrabold text-ink">
            ...
            <div className="relative mt-4 -mb-1 overflow-hidden [mask-image:linear-gradient(to_right,black_92%,transparent)] sm:hidden">
